package top.liulei.cloud.community.mall.common.common;
...
public class Constant {
    ...
    public static final String COMMUNITY_MALL_USER = "community_mall_user";
    ...
    public enum OrderStatusEnum {
        ...
        public static OrderStatusEnum codeOf(int code) {
            ...
            throw new CommunityMallException(CommunityMallExceptionEnum.NO_ENUM);
        }
